...
/*funcion actualizada para abrir modales de perfil, historial y salida inesperada de aprendices*/
const openModal = async (type, apprentice) => {
  ...
  if (type === "attendance") {
    ...
    try {
      ...
      const response = await fetch(
        `${BASE_URL}/api/asistencia/historial/${apprentice.doc}`
      );
      ...
      selectedApprentice.value = {
        ...apprentice,
        absences: historial.faltas_totales,
