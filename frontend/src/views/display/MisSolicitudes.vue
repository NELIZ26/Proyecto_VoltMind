  ...
  if (form.value.correo_instructor) {
    try {
      ...
      if (res.ok) {
        ...
        if (instructorReal) {
          if (instructorReal.cr6a3_nombre_completo) {
            form.value.nombre_instructor = instructorReal.cr6a3_nombre_completo;
          }
          if (instructorReal.cr6a3_nro_telefono) {
            form.value.celular_instructor = instructorReal.cr6a3_nro_telefono;
          }
        }
      }
    } catch (error) {
